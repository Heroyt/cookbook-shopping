...
final class AgentChangeSetIndexRequest extends FormRequest
{
    /** @return array<string, mixed> */
    public function rules(): array
    {
        return [
            'status' => ['nullable', Rule::in(['previewed', 'applied', 'expired', 'invalidated', 'stale'])],
    ...
    /** @return array{status: string|null, credential_id: int|null, issuer_user_id: int|null, date_from: string|null, date_to: string|null, resource_type: string|null, outcome: string|null} */
