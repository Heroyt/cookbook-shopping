...
- [Cookbook routes](../../routes/cookbook.php) expose Current-Family-scoped Store listing, creation, renaming, and deletion; Store Section creation; and Store–Section attach, removal, and reorder commands.
