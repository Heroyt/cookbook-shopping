...
- [Stores and shopping order](stores-shopping-order.md) — implemented Store lifecycle, reusable Store Section creation/listing, and per-Store association/order plus planned Section deletion, placement effects, and final grouping.
