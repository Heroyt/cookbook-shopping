...
This guide is the main technical entry point for developing and operating the cookbook and shopping-planning application. It describes the implemented Family, Cookbook, Shopping Generation, Simple Plan, Calendar, and saved-history workflows through Slice 7, plus the approved Agent Integration design that remains planned.
...
1. [Current application](current-application.md) — implemented routes, authentication, frontend shell, domain workflows, and persistence.
...
6. [Recipes and Ingredients](recipes-ingredients.md) — implemented packaged Ingredients, versioned Recipe aggregates, Tags, search, archive/restore, and media.
7. [Nutrition](nutrition.md) — implemented Ingredient profiles, Recipe calculation and overrides, incomplete profiles, and Calendar totals.
8. [Stores and shopping order](stores-shopping-order.md) — implemented Store, reusable Section, icon, association/order, placement, and generated grouping behavior.
9. [Calendar planning](calendar-planning.md) — implemented Calendar Entries, derived days, Meal Labels, weekly planning, Calendar Selection, and Simple Plan.
10. [Shopping-list generation](shopping-generation.md) — implemented pure calculation, alternatives, grouping, typed problems, and immutable history.
11. [Data structure](data-structure.md) — implemented persistence, ownership keys, constraints, Recipe aggregates, Calendar Entries, and snapshots.
12. [Frontend architecture and navigation](frontend-navigation.md) — current responsive management, planning, generation, and history workflows.
