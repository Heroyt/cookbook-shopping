...
- The latest documentation-tool release omits the installer required by the skill, so mechanical validation and PDF publication remain unavailable until a corrected release is published.
...
- The missing release installer is a temporary exception that blocks PDF and full mechanical publication gates; it does not permit a publish-ready claim.
