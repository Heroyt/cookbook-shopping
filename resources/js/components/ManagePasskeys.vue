...
<template>
    <div v-if="canManagePasskeys" class="space-y-6">
        <Heading
            ...
            description="Spravujte přístupové klíče pro přihlášení bez hesla"
        />
        ...
        <div class="overflow-hidden rounded-lg border border-border">
            ...
            <div v-else class="p-8 text-center">
                ...
                <p class="font-medium">Zatím nemáte žádné přístupové klíče</p>
                <p class="mt-1 text-sm text-muted-foreground">
                    Přidejte přístupový klíč a přihlašujte se bez hesla
                </p>
            </div>
        </div>
